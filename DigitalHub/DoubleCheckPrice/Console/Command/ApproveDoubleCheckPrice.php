 ...
 * @codeCoverageIgnore
 */
class ApproveDoubleCheckPrice extends Command
{

    /**
     * ApproveDoubleCheckPrice constructor
     *
     */
    ...
    {
        $this->setName('digitalhub:update-double-check-price:approve');
        $this->setDescription('Command to approve Double Check Price');
        $this->setDefinition(
            [
                new InputArgument(
                    "id",
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->doubleCheckPriceRepositoryInterface->approveStatusDoubleCheckPrice($id);
